    ...
    return (
        <div className="gmr__create_post">
            <div className="gmr__inline">
                <img src={avatar} alt="Avatar de Joe Dalton" className="gmr__avatar_feed" />
                <textarea className="gmr__create_textarea" placeholder="Tell us what you think about your most liked game"></textarea>
            </div>
